...
(custom-set-variables
 ...
 '(package-selected-packages
	  '(agent-shell apheleia auto-dark batppuccin breadcrumb cape
			catppuccin-theme colorful-mode consult-dir
			consult-eglot-embark corfu diff-hl doom-modeline eat
