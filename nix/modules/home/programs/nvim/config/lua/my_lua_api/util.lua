...
mod.comment_indicators = function(comments)
	...
	if rslt.doc.block.inner.pre == '' then rslt.doc.block.inner.pre = rslt.doc.block.outer.pre end
	if rslt.normal.block.pre == '' then rslt.normal.block.pre = rslt.doc.block.outer.pre end
	if rslt.doc.line.inner == '' then rslt.doc.line.inner = rslt.doc.line.outer end
